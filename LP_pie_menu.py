...
bl_info = {
    ...
    "version": (0, 0, 1),
    "blender": (2, 76, 0),
    "description": "Custom Pie Menus - remix Wazou_Pie_Menus",
    "category": "3D View",}
...
# Pie Smooth group and uv seam
class PieObjectEditotherModes(Menu):
    bl_idname = "pie.seamsharp"
    bl_label = "Sharp / Seam"
    ...
    def draw(self, context):
        ...
        pie = layout.menu_pie()
        #4 - LEFT
        pie.operator("class.markseam", text="Makr Seam", icon='ZOOMIN')
        #6 - RIGHT
        pie.operator("class.cleaseam", text="Clear Seam", icon='ZOOMOUT')
        #2 - BOTTOM
        pie.operator("class.clearsharp", text="Clear sharp", icon='ROOTCURVE')
        #8 - TOP
        pie.operator("class.marksharp", text="Makr sharp", icon='LINCURVE')
        #7 - TOP - LEFT 
        #9 - TOP - RIGHT
        #1 - BOTTOM - LEFT
        #3 - BOTTOM - RIGHT
...
class PieObjectEditMode(Menu):
    ...
    def draw(self, context):
        ...
        if ob and ob.type == 'MESH' and ob.mode in {'OBJECT', 'SCULPT', 'VERTEX_PAINT',
            ...
            #1 - BOTTOM - LEFT
            pie.operator("wm.call_menu_pie", text="Sharp/Seam", icon='PINNED').name="pie.seamsharp"
            #3 - BOTTOM - RIGHT
